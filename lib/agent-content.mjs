...
function buildContentPages() {
  ...
  const maturity = {
    title: 'Teste de Maturidade Imobiliária | OCA Digital',
    description:
      'Responda 10 perguntas e descubra o nível de maturidade da sua imobiliária, do artesanal à IA, e qual gargalo trava o próximo passo.',
    h1: 'Em qual dos 5 níveis está a sua imobiliária?',
    sections: [
      {
        paragraphs: [
          'Teste gratuito de 10 perguntas, com resultado sem cadastro, baseado no Modelo de Maturidade Imobiliária da OCA Digital. O modelo se inspira no CMMI e no MPS.BR e é uma adaptação para a rotina de imobiliárias, não uma certificação.',
        ],
      },
      {
        h2: 'Os 5 níveis',
        list: [
          'Nível 1, Inicial ou artesanal: o sucesso depende do esforço individual.',
          'Nível 2, Gerenciado: CRM unificado e funil básico.',
          'Nível 3, Definido: papéis especializados, processos documentados e onboarding.',
          'Nível 4, Gerenciado por dados: BI, CAC por canal, vacância e ROI por portal.',
          'Nível 5, Em otimização: IA, automação e testes contínuos.',
        ],
      },
    ],
  };
