  ...
  const home = {
    ...
    sections: [
      ...
      },
      {
        h2: 'Nossos Serviços',
        list: [
          'Google Ads e Meta Ads — campanhas de performance e remarketing',
          'SDR — núcleo de pré-qualificação de leads com CRM e dashboard',
          'Automação de Marketing — lead scoring e cadência de e-mails',
          'Lançamento Imobiliário — campanhas completas de pré-lançamento',
          'Pacotes mensais — Essencial, Avançado e Full',
        ],
      },
      {
        h2: 'Nossos Produtos',
        list: [
          'OCA One — plataforma com IA no WhatsApp que centraliza leads e automatiza a qualificação',
          'OCA Base — site profissional integrado aos maiores portais imobiliários',
          'Curso para Corretores — treinamento de marketing imobiliário',
        ],
      },
      {
        h2: 'Quem Somos',
        paragraphs: [
          'Nosso nome vem da sigla OCA: Organização de Processos, Captação de Leads e Automação de Marketing — os três pilares da nossa metodologia. Já ajudamos mais de 50 clientes a estruturar seus processos comerciais e alcançar resultados mensuráveis.',
        ],
      },
      {
        h2: 'Contato',
    ...
    sections: [
      {
        ...
        paragraphs: [
          ...
          'Com mais de 50 clientes ativos e resultados comprovados, ajudamos imobiliárias de todos os tamanhos a transformarem seus processos e alcançarem resultados excepcionais.',
        ],
      },
      {
