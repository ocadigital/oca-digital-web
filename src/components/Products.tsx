          ...
          <Card className="p-8 bg-gradient-to-br from-blue-50 to-blue-100 border-blue-200">
            ...
            <div className="space-y-4 mb-8">
              <div className="bg-white p-4 rounded-lg">
                ...
                <p className="text-gray-600">Atendimento automatizado e pré-qualificação inteligente</p>
              </div>
              
              <div className="bg-white p-4 rounded-lg">
                <h4 className="font-bold text-blue-600 mb-2">📊 CRM com automação integrada</h4>
                <p className="text-gray-600">Gestão completa sem custos extras de integrações</p>
              </div>
              
              <div className="bg-white p-4 rounded-lg">
                <h4 className="font-bold text-blue-600 mb-2">🏠 Avaliação e captação inteligente</h4>
                <p className="text-gray-600">Base no comportamento real do mercado</p>
              </div>
              
              <div className="bg-white p-4 rounded-lg">
                <h4 className="font-bold text-blue-600 mb-2">📈 Inteligência de mercado</h4>
                <p className="text-gray-600">Insights e análises para decisões estratégicas</p>
              </div>
            </div>

            <div className="text-center">
              <div className="text-3xl font-bold text-blue-600 mb-2">A partir de R$ 497/mês</div>
              <p className="text-gray-600 mb-6">Setup personalizado incluído</p>
          ...
          <Card className="p-8 bg-gradient-to-br from-gray-50 to-gray-100 border-gray-200">
            ...
            <div className="space-y-4 mb-8">
              ...
              <div className="bg-white p-4 rounded-lg">
                ...
                <p className="text-gray-600">Conecte-se aos maiores portais imobiliários</p>
              </div>
              
              <div className="bg-white p-4 rounded-lg">
                <h4 className="font-bold text-gray-800 mb-2">📋 Gestão de imóveis</h4>
                <p className="text-gray-600">Cadastre e organize toda sua carteira</p>
              </div>
              
              <div className="bg-white p-4 rounded-lg">
                <h4 className="font-bold text-gray-800 mb-2">💰 Preço acessível</h4>
                <p className="text-gray-600">Solução que cabe no seu orçamento</p>
              </div>
            </div>

            <div className="text-center">
              <div className="text-3xl font-bold text-gray-800 mb-2">Consulte valores</div>
