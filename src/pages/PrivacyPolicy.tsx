          ...
          <div className="prose prose-lg max-w-none">
            ...
            <div className="space-y-8">
              ...
              <section>
                ...
                <p className="text-foreground/90 mb-4">Coletamos os seguintes tipos de informações:</p>
              ...
              <section>
                ...
                <p className="text-foreground/90 mb-4">Utilizamos seus dados para:</p>
                <ul className="list-disc pl-6 text-foreground/90 space-y-2">
              ...
              <section>
                ...
                <p className="text-foreground/90 mb-4">Você tem o direito de:</p>
                <ul className="list-disc pl-6 text-foreground/90 space-y-2">
