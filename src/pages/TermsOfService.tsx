        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg prose-invert max-w-none">
            ...
            <div className="space-y-8">
              ...
              <section>
                <h2 className="text-2xl font-bold text-foreground mb-4">3. Elegibilidade</h2>
                <p className="text-muted-foreground mb-4">
              ...
              <section>
                ...
                <p className="text-muted-foreground mb-4">Você se compromete a:</p>
                <ul className="list-disc pl-6 text-muted-foreground space-y-2">
              ...
              <section>
                <h2 className="text-2xl font-bold text-foreground mb-4">7. Pagamentos e Cancelamentos</h2>
                <p className="text-muted-foreground mb-4">
              ...
              <section>
                ...
                <div className="bg-muted p-4 rounded-lg">
                  <p className="text-muted-foreground"><strong>E-mail:</strong> contato@ocadigital.com.br</p>
                  <p className="text-muted-foreground"><strong>Telefone:</strong> (11) 99999-9999</p>
                </div>
              </section>
            </div>
          </div>
